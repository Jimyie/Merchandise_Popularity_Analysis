  ...
  Date time=null;
 	...
 	try {
		...
		e.printStackTrace();
		    	   ...
		    	   String stardardbottomstring="2016-06-30 23:59";
		    	   try {
		    	   ...
		    	   String stardardpeakstring="2016-10-01 00:00";
		    	   try {
...
public static void main(String[] args) throws Exception {
 ...
 if (otherArgs.length != 2) {
   System.err.println("Usage: catagory analytics <in> <out>");
   System.exit(2);
 }
 Job job = new Job(conf, "Catagory Analytics");
 job.setJarByClass(CatagoryAnalytics.class);
